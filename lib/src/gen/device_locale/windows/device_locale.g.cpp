...
const ::flutter::StandardMessageCodec& DeviceLocaleHostApi::GetCodec() {
...
void DeviceLocaleHostApi::SetUp(
  ::flutter::BinaryMessenger* binary_messenger,
  DeviceLocaleHostApi* api) {
  DeviceLocaleHostApi::SetUp(binary_messenger, api, "");
}
...
void DeviceLocaleHostApi::SetUp(
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.oh_my_flutter.DeviceLocaleHostApi.getCountry" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          ErrorOr<std::optional<std::string>> output = api->GetCountry();
          if (output.has_error()) {
...
EncodableValue DeviceLocaleHostApi::WrapError(std::string_view error_message) {
...
EncodableValue DeviceLocaleHostApi::WrapError(const FlutterError& error) {
  return EncodableValue(EncodableList{
