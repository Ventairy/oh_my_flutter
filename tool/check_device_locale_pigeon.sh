...
fvm dart format \
  ...
  "$pigeon_check_directory/lib/src/gen/device_locale/device_locale.g.dart" \
  >/dev/null

generated_files=(
  "lib/src/gen/device_locale/device_locale.g.dart"
  "lib/src/gen/device_locale/android/DeviceLocale.g.kt"
  "lib/src/gen/device_locale/apple/DeviceLocale.g.swift"
  "lib/src/gen/device_locale/windows/device_locale.g.h"
  "lib/src/gen/device_locale/windows/device_locale.g.cpp"
)
is_current=true
...
if [[ "$is_current" != true ]]; then
  echo 'Run ./tool/generate_device_locale_pigeon.sh.' >&2
  exit 1
fi
