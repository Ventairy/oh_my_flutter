...
void main() {
  group('OfflineConnectionException', () {
    test('when constructed with a message, it should expose the message', () {
      const exception = OmfOfflineConnectionDioException(message: 'No internet connection.');
    ...
    test('when constructed with a cause, it should expose the cause', () {
      ...
      final exception = OmfOfflineConnectionDioException(message: 'No internet connection.', cause: cause);
