...
/// Tracks lifecycle and focus changes during one Skeleton timing window.
final class SkeletonBenchmarkInterruptionTracker {
  /// Creates a tracker with the binding's currently known lifecycle state.
  SkeletonBenchmarkInterruptionTracker(this._lifecycleState);
