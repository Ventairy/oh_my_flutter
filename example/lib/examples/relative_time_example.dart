...
class RelativeTimeExample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final label = withClock(
      ...
      () => DateTime.utc(2026, 1, 1, 11, 55).timeAgo<String>(onMinutesAgo: (minutes) => '$minutes minutes ago'),
    );

    return DecoratedBox(
      decoration: BoxDecoration(color: const Color(0xFFFF4A4B), borderRadius: BorderRadius.circular(16)),
      child: Padding(
