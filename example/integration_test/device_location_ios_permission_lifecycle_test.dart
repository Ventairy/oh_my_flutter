...
void main() {
  ...
  testWidgets('when iOS backgrounds an active permission prompt, it should resolve it', (_) async {
    ...
    expect(
      ...
      (opened: true, failure: DeviceLocationExceptionReason.operationUnavailable),
    );
