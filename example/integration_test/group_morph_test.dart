...
void main() {
  ...
  testWidgets(
    'when grouped content expands and reverses, '
    'it should keep the nested title independent',
    (tester) async {
      ...
      await File('${screenshots.path}/midflight.png').writeAsBytes(
        await binding.takeScreenshot('group_morph_midflight'),
      );
      ...
      await tester.tap(find.text('Expand card'));
      await tester.pumpAndSettle();
      await File('${screenshots.path}/settled.png').writeAsBytes(
        await binding.takeScreenshot('group_morph_settled'),
      );
