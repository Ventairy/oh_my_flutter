...
void main() {
  testWidgets('when the Marquee example builds, it should display every source item', (tester) async {
    await tester.pumpWidget(const MaterialApp(home: Scaffold(body: MarqueeExample())));
