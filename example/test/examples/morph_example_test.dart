...
void main() {
  testWidgets('when the Morph actions are used, it should transfer on screen and '
      'across a route', (tester) async {
    final morphObserver = MorphNavigatorObserver();
    await tester.pumpWidget(
      MaterialApp(
        navigatorObservers: [morphObserver],
        home: const Scaffold(body: SingleChildScrollView(child: MorphExample())),
      ),
    );
    ...
    expect((destinationVisible, find.text('Route destination').evaluate().isNotEmpty), (true, true));
  });
}
