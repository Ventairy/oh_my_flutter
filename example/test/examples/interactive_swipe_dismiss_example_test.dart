...
void main() {
  testWidgets('when the example is opened, it should show an interactive handle', (tester) async {
    await tester.pumpWidget(const MaterialApp(home: Scaffold(body: InteractiveSwipeDismissExample())));
