...
void main() {
  testWidgets('when the Skeleton example builds, it should use the shimmer treatment', (tester) async {
    await tester.pumpWidget(const MaterialApp(home: Scaffold(body: SkeletonExample())));
